...
public class ContainerDatabase extends Database<Container> implements Serializable {
    ...
    public void loadContainerOnVehicle(String vehicleId, String userPortId) {
        ...
        while (true) {
           ...
           if (container.getVehicleId() != null) {
            ...
            mdb.ports.find(container.getPortId()).removeContainer(container);
    ...
    public void unloadFromVehicle(String vehicleId, String userPortId) {
        ...
        Port port = mdb.ports.find(vehicle.getPortId());
        if (port == null) {
...
//    }
    ...
    public Container updateRecord(String id) {
        ...
        container.setPortId(getInputId("Port ID: ", container.getPortId(), scanner, mdb.ports));

        container.setVehicleId(getInputId("Vehicle ID: ", container.getVehicleId(), scanner, mdb.vehicles));
    ...
    public Container delete(String id) {
        ...
        if (mdb.ports.exists(deletedContainer.getPortId())) {
            Port port = mdb.ports.find(deletedContainer.getPortId());
            port.removeContainer(deletedContainer);
        }

        if (mdb.vehicles.exists(deletedContainer.getVehicleId())) {
            Vehicle vehicle = mdb.vehicles.find(deletedContainer.getVehicleId());
