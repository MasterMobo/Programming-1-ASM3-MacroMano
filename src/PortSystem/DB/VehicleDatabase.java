...
public class VehicleDatabase extends Database<Vehicle> {
    ...
    public String showInfo(String vehicleID) {
        ...
        return
                ...
                "\n         carryCapacity=" + foundVehicle.getCarryCapacity() + ", curCarryWeight=" + foundVehicle.getCurCarryWeight() + ", fuelCapacity=" + foundVehicle.getFuelCapacity() + ", curFuelAmount=" + foundVehicle.getCurFuelAmount() + ", " +
